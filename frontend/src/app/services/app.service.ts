...
import { Category, MenuItem, Order } from '@models/app.models';
...
export class AppService {
    ...
    if (!this.Data.cartList.find(item => item.id == menuItem.id)) {
      ...
      if (component) {
        ...
        this.snackBar.open('The menu item "' + menuItem.name + '" has been added to cart.', '×', {
          ...
          duration: 3000,
          direction: (this.settingsService.settings.rtl) ? 'rtl' : 'ltr',
          panelClass: ['success']
        });
      }
    }
  ...
  public getAwards() {
    return [
      { name: 'award-1', image: 'images/awards/1.png' },
      { name: 'award-2', image: 'images/awards/2.png' },
      { name: 'award-3', image: 'images/awards/3.png' },
      { name: 'award-4', image: 'images/awards/4.png' },
      { name: 'award-5', image: 'images/awards/5.png' },
      { name: 'award-6', image: 'images/awards/6.png' },
      { name: 'award-7', image: 'images/awards/7.png' }
    ];
  }
