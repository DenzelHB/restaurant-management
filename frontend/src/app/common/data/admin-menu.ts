...
export const adminMenuItems = [
    ...
    new AdminMenu(20, 'ADMIN_NAV.MENU_ITEMS', null, null, 'grid_on', null, true, 0),
    new AdminMenu(21, 'ADMIN_NAV.CATEGORIES', '/admin/menu-items/categories', null, 'category', null, false, 20),
    new AdminMenu(22, 'ADMIN_NAV.MENU_ITEMS_LIST', '/admin/menu-items/list', null, 'list', null, false, 20),
    new AdminMenu(23, 'ADMIN_NAV.MENU_ITEM_DETAIL', '/admin/menu-items/detail', null, 'remove_red_eye', null, false, 20),
    new AdminMenu(24, 'ADMIN_NAV.ADD_MENU_ITEM', '/admin/menu-items/add', null, 'add_circle_outline', null, false, 20),
    ...
    new AdminMenu(45, 'ADMIN_NAV.RESERVATIONS', '/admin/reservations', null, 'event', null, false, 0),
